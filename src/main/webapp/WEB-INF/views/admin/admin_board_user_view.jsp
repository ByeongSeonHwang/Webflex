			...
			<div class="page-breadcrumb">
				<div class="row">
					<div class="col-12 d-flex no-block align-items-center">
						<h4 class="page-title">사용자 게시판</h4>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								<h5 class="card-title m-b-0">사용자 게시글 </h5>
								<hr>
							</div>
							<div class="card-body" style="padding: 0% 5%">

								<h6>no. ${board.board_no }</h6>
								<br>
								<h6>
									&nbsp; &nbsp;
								...
								<div class="comment-widgets scrollable" style="padding: 0% 2%">
									...
									<h6>작성자 : ${board.board_writer }</h6>
									<hr>
									<h6>내용</h6>
									<hr>
									<span class="m-b-15 d-block">${board.board_cont }</span>
									<hr>
									<div id="buttons">		
									<br>							
										<input type="button" class="btn btn-danger btn-sm"
											style="margin: auto;" onclick="location.href='/admin_board_user_delete?board_no=${board.board_no}';" value="삭제"/>
									</div>
										<br>
