...
<!-- 사용자 게시판 올라온 글 -->
				<div class="card">
							<div class="card-body">
								<h5 class="card-title">사용자 게시판 등록된 글</h5>
								<div class="table-responsive">


					<div id="searchbox">
						
					<form action="/admin_board_search" method="get" onsubmit="return search_check();">
                     <label class="col-md-3" ><button type="submit" style=" background-color: white; /* margin-left: auto; */ width: 50px; height: 40px; border-color: black; " >검색</button></label>
									...
									<table id="zero_config"
										...
										<tbody>
											<tr>
												...
												<td><a href="/admin_board_user_view?board_no=${blist.board_no }">${blist.board_title }</a></td>
	...
	<%-- 검색전 페이징 --%>
	   <c:if test="${page<=1}">
	    ...
	    <c:if test="${page>1}">
	    <div class="btn">
	     <a id="board_list" href="./admin_board_user?page=${page-1}">&lt;</a>
	      </div>
	    </c:if>
	    ...
	    <c:forEach var="a" begin="${startpage}" end="${endpage}" step="1">
	     ...
	     <c:if test="${a != page}"><%--현재 페이지가 선택되지 않았다면 --%>
	      <div class="no">
	     <a id="board_list" href="./admin_board_user?page=${a}">
	      ${a}
	     </a>
	      </div>
	     </c:if>
	    ...
	    <c:if test="${page < maxpage}">
	    <div class="btn">
	    	<a id="board_list" class="end" href="./admin_board_user?page=${page+1}">&gt;</a>
	     </div>
	    </c:if>
