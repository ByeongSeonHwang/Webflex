...
<link rel="icon" type="image/png" sizes="16x16"
	href="./resources/images/new logo.png">
<title>영화 한줄평</title>
<!-- Custom CSS -->
...
<body>
	...
	<div id="main-wrapper">
		...
		<header class="topbar" data-navbarbg="skin5">
			<nav class="navbar top-navbar navbar-expand-md navbar-dark">
				<div class="navbar-header" data-logobg="skin5">
					...
					<!-- Logo -->
					<!-- ============================================================== -->
					<a class="navbar-brand" href="admin"> <!-- Logo icon --> <b
						class="logo-icon p-l-10"> <!--You can put here icon as well // <i class="wi wi-sunset"></i> //-->
							<!-- Dark Logo icon --> <img
							src="./resources/images/new logo.png" alt="homepage"
							class="light-logo" width="25px" height="25px" />

					</b> <!--End Logo icon --> <!-- Logo text --> <span class="logo-text">
							<!-- dark Logo text --> <img
							src="./resources/images/logo_red_new.png" alt="homepage"
							class="light-logo" width="135px" height="25px" />
				...
				<div class="navbar-collapse collapse" id="navbarSupportedContent"
					...
					<ul class="navbar-nav float-right">
						...
						<li class="nav-item dropdown"><a
							...
							aria-expanded="false"><img img
								src="./resources/images/new logo.png" alt="user"
					...
					<ul id="sidebarnav" class="p-t-30">
						<li class="sidebar-item"><a
							...
							href="admin" aria-expanded="false"><i
								class="mdi mdi-view-dashboard"></i><span class="hide-menu">관리자
									페이지</span></a></li>
						<li class="sidebar-item"><a
							class="sidebar-link waves-effect waves-dark sidebar-link"
							href="admin_user" aria-expanded="false"><i
								class="mdi mdi-border-inside"></i><span class="hide-menu">회원
									관리</span></a></li>
						<li class="sidebar-item"><a
							class="sidebar-link has-arrow waves-effect waves-dark"
							href="javascript:void(0)" aria-expanded="false"><i
								class="mdi mdi-receipt"></i><span class="hide-menu">영화</span></a>
							<ul aria-expanded="false" class="collapse  first-level">
								<li class="sidebar-item"><a href="movie_info"
									class="sidebar-link"><i class="mdi mdi-note-outline"></i><span
										class="hide-menu">영화 정보 </span></a></li>
								<li class="sidebar-item"><a href="movie_insert"
									class="sidebar-link"><i class="mdi mdi-note-plus"></i><span
										class="hide-menu"> 영화 추가</span></a></li>
								<li class="sidebar-item"><a href="movie_edit"
									class="sidebar-link"><i class="mdi mdi-note-plus"></i><span
										class="hide-menu"> 영화 수정</span></a></li>
								<li class="sidebar-item"><a href="movie_comment"
									class="sidebar-link"><i class="mdi mdi-note-plus"></i><span
										class="hide-menu"> 영화 한줄평</span></a></li>
							</ul>
						<li class="sidebar-item"><a
							class="sidebar-link has-arrow waves-effect waves-dark"
							href="javascript:void(0)" aria-expanded="false"><i
								class="mdi mdi-receipt"></i><span class="hide-menu">게시판</span></a>
							<ul aria-expanded="false" class="collapse  first-level">
								<li class="sidebar-item"><a href="admin_board"
									class="sidebar-link"><i class="mdi mdi-note-outline"></i><span
										class="hide-menu">공지사항 </span></a></li>
								<li class="sidebar-item"><a href="admin_board_insert"
									class="sidebar-link"><i class="mdi mdi-note-plus"></i><span
										class="hide-menu"> 공지사항 등록</span></a></li>
								<li class="sidebar-item"><a href="admin_board_user"
									class="sidebar-link"><i class="mdi mdi-note-plus"></i><span
										class="hide-menu"> 사용자 게시판 관리</span></a></li>
							</ul></li>
					</ul>
				</nav>
		...
		<div class="page-wrapper">
			...
			<form action="/movie_comment_ok">
				<div class="card">
					<div class="card-body">
						<h5 class="card-title">영화 한 줄 평</h5>


							<div class="form-group row">
								<label class="col-md-3">영화 제목 검색</label>
								<div class="col-md-9">
									<input type="text" id="disabledTextInput" name="movie_title" class="form-control">
								</div>
							</div>
							<div class="form-group row" id="form_group_row">
								<input type="radio" name="name" value="dragon">
								<p id="name">이용준</p>
								<input type="radio" name="name" value="joy">
								<p id="name">신나은</p>
								<input type="radio" name="name" value="fire">
								<p id="name">이동열</p>
								<input type="radio" name="name" value="stone">
								<p id="name">오진석</p>
								<input type="radio" name="name" value="sun">
								<p id="name">황병선</p>
							</div>

							<div class="form-group row">
								<label class="col-md-3">한줄평</label>
								<div class="col-md-9">
									<input type="text" id="disabledTextInput" name="movie_comment" class="form-control1">
								</div>
							</div>
					</div>
					...
					<div class="border-top">
						<div class="card-body">
							...
							<input type="submit" class="btn btn-danger btn-sm" value="등록하기"
								style="margin-left: 50% !important; margin-right: 5px !important;">
						</div>
					</div>
				</div>
			</form>
		...
		<footer class="footer text-center">
			&copy; WEBFLEX Services Korea &nbsp;<br>
			<br> 대표: 이용준 &nbsp;이메일 주소:webflex@webflex.com &nbsp; 주소: 서울 동작구
			장승배기로 171 2층, 3층
		</footer>
		<!-- ============================================================== -->
		<!-- End footer -->
