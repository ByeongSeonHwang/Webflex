   ...
   <div id="main-wrapper">
                    ...
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">게시판</span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                ...
                                <li class="sidebar-item"><a href="admin_board_insert" class="sidebar-link"><i class="mdi mdi-note-plus"></i><span class="hide-menu"> 사용자 게시판 관리</span></a></li>
                            </ul>
                        </li>           
                        </ul>
                </nav>
      ...
      <div class="page-wrapper">
         ...
         <div class="container-fluid">
            <!-- ============================================================== -->
            <!-- Start Page Content -->
<form action="/admin_board_edit_ok" method="post">
            ...
            <div class="card">
               ...
               <br>
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-md-9">
                        <input type="text" value="${notice.notice_title }" name="notice_title" id="disabledTextInput" class="form-control">
                     </div>
                  </div>
                  <div class="form-group row">
                     <label class="col-md-3" >작성자</label>
                     <div class="col-md-9">
                        <input type="text" value="${notice.notice_writer }"name="notice_writer"  id="disabledTextInput" class="form-control">
                     </div>
                  </div>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-md-9">
                            <textarea id="disabledTextInput" name="notice_cont" class="form-control1" >${notice.notice_cont }</textarea>
                      </div>
                  </div>
               </div>
               ...
               <div class="border-top">
                  <div class="card-body">
                     <button id="btn-board" type="reset" class="btn btn-danger btn-sm">취소</button>
